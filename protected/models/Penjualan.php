...
class Penjualan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('iddatauser, idproduct, jumlah', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idpenjualan, iddatauser, idproduct, jumlah', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idpenjualan',$this->idpenjualan);
